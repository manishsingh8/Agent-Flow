...
// src/constants/rcmDashboardData.ts
// Full RCM dataset (typed) - exported for use across dashboard components.
// NOTE: This file was constructed directly from the JSON you provided.
...
/**
 * Paste your JSON here - already converted to typed object.
 * (This object is exactly the data you provided in the last message.)
 */
